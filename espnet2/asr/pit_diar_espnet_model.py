...
class ESPnetASRModel(SingleESPnetASRModel):
    ...
    def __init__(
        ...
        train_config = "/home/js-gpu2-01/workspace_ssd/espnet/egs2/librimix/diar1/exp/diar_train_diar_eda_raw/config.yaml"
        model_file = "/home/js-gpu2-01/workspace_ssd/espnet/egs2/librimix/diar1/exp/diar_train_diar_eda_raw/valid.acc.ave_10best.pth"
        
        self.diar_model = DiarizeSpeech(
    ...
    def encode(
        ...
        with autocast(False):
            ...
            if self.diar_model is not  None:
                diar_result = torch.from_numpy(self.diar_model(speech)[1])
                diar_result = diar_result.to(speech)
            # 2. Data augmentation
        ...
        if self.encoder.interctc_use_conditioning:
            ...
            encoder_out, encoder_out_lens, _ = self.encoder(feats, feats_lengths, diar_result)
